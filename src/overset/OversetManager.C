...
//--------------------------------------------------------------------------
//-------- overset_orphan_node_field_update --------------------------------
//--------------------------------------------------------------------------
void
...
//--------------------------------------------------------------------------
void
OversetManager::initialize_ghosting()
{
...
//--------------------------------------------------------------------------
void
OversetManager::declare_inactive_part()
{
...
//--------------------------------------------------------------------------
void
OversetManager::declare_background_surface_part()
{
  // not sure where this needs to be in order for the block to show up in the output file?
...
//--------------------------------------------------------------------------
void
OversetManager::define_overset_bounding_box()
{
  // extract coordinates
...
//--------------------------------------------------------------------------
void
OversetManager::determine_intersected_elements()
{
...
//--------------------------------------------------------------------------
void
OversetManager::populate_inactive_part()
{
...
//--------------------------------------------------------------------------
void
OversetManager::set_orphan_surface_part_vec()
{
...
//--------------------------------------------------------------------------
void
OversetManager::create_overset_info_vec()
{
  // extract coordinates
  VectorFieldType *coordinates
    = metaData_->get_field<VectorFieldType>(stk::topology::NODE_RANK, realm_.get_coordinates_name());
...
//--------------------------------------------------------------------------
void
OversetManager::orphan_node_search()
{
  // coarse search 
  coarse_search(
...
//--------------------------------------------------------------------------
void
OversetManager::manage_ghosting()
{  
